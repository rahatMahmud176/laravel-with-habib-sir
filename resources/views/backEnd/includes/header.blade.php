            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item text-danger" href="#" onclick="event.preventDefault()
                                                                            document.getElementById('logOutForm').submit()" ><i class="bx bx-power-off font-size-16 align-middle mr-1 text-danger"></i> Logout</a>
                </div>
                {{ Form::open(['id'=>'logOutForm','route'=>'logout','method'=>'POST']) }}
