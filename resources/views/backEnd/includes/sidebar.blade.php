            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('subCategory.index') }}">Sub Category Manage</a></li> 
                        <li><a href="{{ route('brand.index') }}">Brand Manage</a></li> 
                        <li><a href="{{ route('color.index') }}">Color Manage</a></li> 
                        <li><a href="{{ route('size.index') }}">Size Manage</a></li> 
                        <li><a href="{{ route('unit.index') }}">Unit Manage</a></li> 
                        <li><a href="{{ route('supplier.index') }}">Suplier Manage</a></li> 
                    </ul>
                </li>
                 <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('productAddPage') }}">Add Product</a></li>  
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('stockAddPage') }}">Add Strock</a></li>  
                        <li><a href="{{ route('category.index') }}">Manage Strock</a></li>  
                    </ul>
                </li>
